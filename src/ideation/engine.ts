...
export function buildIdeationSystemPrompt() {
  return [
    ...
    "- No uses palabras sueltas como criterio de bloqueo. Ninguna palabra esta prohibida por si misma; evalua siempre la logica completa de la idea.",
    "",
    "INPUT OBLIGATORIO",
    ...
    "8. Cruzar cada idea contra antipatrones antes de responder. Si cae conceptualmente en solucion antes que problema o beneficio sin mecanica, reformulala desde el mecanismo antes de responder.",
    ...
    "Para RUPTURA_FUERTE evalua si la propuesta cambia una regla de compra, acceso, cobro, autoridad, incentivo, riesgo o decision; no uses la presencia de palabras especificas como criterio.",
    "",
    "FORMATO DE IDEAS",
    ...
    "No entregues ideas cuyo centro sea solo ordenar trabajo existente sin modificar una decision observable, incentivo, riesgo, acceso, autoridad o conducta. Evalua esto por significado, no por vocabulario.",
    "",
    "SALIDA INTERNA",
...
export function buildCaseScreeningSystemPrompt() {
  return [
    ...
    "7. Cada caso debe habilitar una idea distinta; evita tres variaciones de la misma logica.",
    "8. Antes de aceptar cada caso, identifica el riesgo conceptual que podria producir: solucion antes que problema, beneficio sin mecanica, tecnologia decorativa, canal sin distribucion, actividad sin cambio de decision o contenedor sin regla observable.",
    ...
    "- Marca como riesgosos los casos que solo inspiran actividad superficial sin mecanismo transferible.",
    "- No descartes por palabras. Descarta o reformula solo cuando el caso no pueda traducirse en una regla observable, incentivo, acceso, riesgo, autoridad o decision distinta.",
...
export function buildConceptReviewSystemPrompt() {
  return [
    ...
    "- Una idea falla si su logica completa solo ordena actividades existentes sin cambiar una regla, incentivo, riesgo, acceso, autoridad o decision observable.",
    ...
    "- Palabras como sistema, proceso, metodologia, comunicacion, app, plataforma, dashboard, IA, comunidad, alianza o capacitacion no son motivo suficiente para fallar. Solo falla si el modelo de la idea es generico, decorativo o sustituye el problema por una solucion obvia.",
